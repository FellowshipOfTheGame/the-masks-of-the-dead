...
public class AGZombie : MonoBehaviour {
    ...
    int waypoint_index = 0; //�ndice do vetor de poss�veis destinos
    private Vector3 direction;//Dire��o que o zumbi anda para chegar no destino.
